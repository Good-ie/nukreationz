...
document.addEventListener("DOMContentLoaded", function () {
  const color_input_sec = document.querySelector(".color-input-sec");
  var root = document.querySelector(":root");

  color_input_sec.addEventListener("input", function () {
    console.log(color_input_sec.value);
    root.style.setProperty("--secondary", color_input_sec.value);
  });
});
document.addEventListener("DOMContentLoaded", function () {
  const text_color_input = document.querySelector(".text-color-input");
  var root = document.querySelector(":root");

  text_color_input.addEventListener("input", function () {
    console.log(text_color_input.value);
    root.style.setProperty("--secondarytext", text_color_input.value);
  });
});


color1.addEventListener('click', function(){
    root.style.setProperty('--primary', '#608FFF');
...
color2.addEventListener('click', function(){
    root.style.setProperty('--primary', '#D51A47');
...
const distance = footerTop - sidebarTop - sidebarHeight;

if (distance > 0) {
  sidebar.style.height = `${sidebarHeight - distance}px`;
}
