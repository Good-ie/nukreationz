    ...
    <div class="faq-section">
        <div class="questions">
            <div class="question1 question">
                ...
                <i class="bi bi-plus-circle btn-1"></i>
            </div>
            <div class="answer1 answer ansdisplay">
            ...
            <div class="question2 question">
                ...
                <i class="bi bi-plus-circle btn-2"></i>
            </div>
            <div class="answer2 answer ansdisplay">
            ...
            <div class="question3 question">
                ...
                <i class="bi bi-plus-circle btn-3"></i>
            </div>
            <div class="answer3 answer ansdisplay">
            ...
            <div class="question4 question">
                ...
                <i class="bi bi-plus-circle btn-4"></i>
            </div>
            <div class="answer4 answer ansdisplay">
            ...
            <div class="question5 question">
                ...
                <i class="bi bi-plus-circle btn-5"></i>
            </div>
            <div class="answer5 answer ansdisplay">
                <p>With the increasing number of online transactions and services, it is important to consider the
                    security of your contact information when storing it on a card. Storing your contact information on
                    a card can be convenient and secure if done properly. In this article, we will discuss the various
                    security measures you should take to ensure that your contact information is safe when stored on a
            ...
            <div class="question6 question">
                ...
                <i class="bi bi-plus-circle btn-6"></i>
            </div>
            <div class="answer6 answer ansdisplay">
            ...
            <div class="question7 question">
                ...
                <i class="bi bi-plus-circle btn-7"></i>
            </div>
            <div " class=" answer7 answer ansdisplay">
            ...
            <div class="question8 question">
                ...
                <i class="bi bi-plus-circle btn-8"></i>
            </div>
            <div class="answer8 answer ansdisplay">
        ...
        <div class="body2">
            <div class="feedback">
                ...
                <form action="" method="POST">
                    ...
                    border-radius: 4px;" type="text" name="complaint" id=""></textarea><br>
                    ...
                    width: 100%; background: #FFFFFF;
                    border: 1px solid #FFFFFF;
                    border-radius: 4px;" type="text" name="email" id=""><br>


                    <button style="margin-top: 20px;" type="submit" name="send_msg">Submit</button>
                </form>
            </div>
