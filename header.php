...
<body>
    <div class="navbar">  
        <div style="z-index: 999; display: flex; justify-content: space-between; width: 100%;" class="nav" id="myHeader">
            <div>
            ...
            <div class="button" id="btn-sticky">
                <a href="login">
                    <button style="background: #FF8B3B; padding: 14px 32px 14px 32px; color: white; border-radius: 12px; border: none;">LOGIN</button>
                </a>
                <a href="register">
                    <button style="margin-left: 0px; background: #F8F8F8; padding: 12px 30px 12px 30px; border: 2px solid #686868; border-radius: 12px;">SIGN UP</button>
                </a>
            </div>
        </div>
        ...
        <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                ...
                <li style="margin-top: 20px;"><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>" href="register">SIGN UP</a></li>
