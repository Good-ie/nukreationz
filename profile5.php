    ...
    <div style="padding: 0; " class="container">
        <div class="profile-img profile3-img">
            ...
            <div style="margin-top: 35px;">
                <h2 style="text-align: left; margin-left: 20px; font-size: 35px;"><?php echo $fname, ' ', $lname?></h2>
                <p style="text-align: left; margin-left: 20px; font-size: 20px;"><?php echo $jobtitle; ?></p>
                <p style="text-align: left; margin-left: 20px; font-size: 20px;"><b><?php echo  $company;?></b></p>
            </div>
