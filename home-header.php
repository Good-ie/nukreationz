    ...
    <div class="navbar" style="display: flex; justify-content: space-evenly;" >
        <div class="nav"  id="myHeader">
            ...
            <div style="text-align: center; margin-left: 100px; justify-content: center; display: flex;" class="nav-text">
                ...
                <!-- <a href="">ABOUT US</a> -->
                <a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="">DASHBOARD</a>
            ...
            <?php  if (isset($_SESSION['username'])) :?>
                ...
                <div  style="display: flex; margin-left: 100px;" id="login-user-button" class="">
                    <a href="">
                        ...
                        box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.12); padding: 8px;" src="./admin/img/user-img.png" alt="nukreationz"  ">
        ...
        <div class="top-profile-card " style="display: none;">
            ...
            <ul>
                <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>" href="user-profile.php">Profile</a></li>
                <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>" href="user-profile.php">Settings</a></li>
    ...
    <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                <li><a class="<?php if($currentPage =='home'){echo 'active';}?>" href="index.php">HOME</a></li><br>
                        <!-- <a href="">ABOUT US</a> -->
                <li><a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details.php">DASHBOARD</a></li><br>
