    ...
    <div class="navbar" style="z-index: 999; display: flex; justify-content: space-evenly;" >
        ...
        <div class="top-profile-card " style="display: none;">
            <div class="top-profile-card-img">
                ...
                <h4 style="font-size: 15px; margin-bottom: 20px; margin-top: 10px;">Current Plan: <b style="text-transform: uppercase;"> <?php echo $newplannow; ?></b></h4>
            </div>
            ...
            <ul style="margin-left: 20px; font-size: 18px;">
                ...
                <li><a class="<?php if($currentPage =='settinga'){echo 'active';}?>" href="profileSettings">Settings</a></li>
    ...
    <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                <li><a class="<?php if($currentPage =='home'){echo 'active';}?>" href="./">HOME</a></li><br>
                        <!-- <a href="">ABOUT US</a> -->
                <li><a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="dashboard">DASHBOARD</a></li><br>
                
                <li><a class="<?php if($currentPage =='tools'){echo 'active';}?>" href="tools">GENERATE QR CODE</a></li><br>
