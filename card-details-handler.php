...
if (isset($_POST['reg_user'])) {
    ...
    $profile1 = mysqli_real_escape_string($db, $_POST['profile2']);
    $profile2 = mysqli_real_escape_string($db, $_POST['profile3']);
    $profile3 = mysqli_real_escape_string($db, $_POST['profile5']);
    // social page 
                ...
                **/
                ...
                if (in_array($img_ex_lc, $allowed_exs)) {
                    ...
                    **/
                    ...
                    $sql  = "INSERT INTO images (user_id, card_id, file_name)
                         VALUES (?,?,?)";
                    $stmt = $db->prepare($sql);
