...
<body>
    ...
    <div class="navbar" style="z-index: 999; display: flex; justify-content: space-evenly;" >
        <div class="nav"  id="myHeader">
            ...
            <div style="text-align: center; margin-left: 100px; justify-content: center; display: flex;" class="nav-text">
                <a class="<?php if($currentPage =='home'){echo 'active';}?>" href="./">HOME</a>
                <!-- <a href="">ABOUT US</a> -->
                <a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details">CREATE CARD</a>
                <a class="<?php if($currentPage =='cardDetails'){echo 'active';}?>" href="card_details_view2">CARD DETAILS</a>
            ...
            <?php  if (isset($_SESSION['username'])) :?>
                ...
                <div  style="display: flex; margin-left: 100px;" id="login-user-button" class="">
                    <a href="">
                        ...
                        box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.12); padding: 2px;" src="<?php if(!empty($profileimage)){echo'uploads/',$profileimage;}else{echo'img/user-img.png';} ?>" alt="nukreationz"  ">
        ...
        <div class="top-profile-card " style="display: none;">
            <div class="top-profile-card-img">
                ...
                <h4 style="font-size: 15px; margin-bottom: 10px;">Current Plan<br> <?php echo $_SESSION['plan']; ?>!</h4>
            </div>

            <ul>
                <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>" href="profileSettings">Profile</a></li>
                <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>" href="profileSettings">Settings</a></li>
    ...
    <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                <li><a class="<?php if($currentPage =='home'){echo 'active';}?>" href="./">HOME</a></li><br>
                        <!-- <a href="">ABOUT US</a> -->
                <li><a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details">CREATE CARD</a></li><br>
                <li><a href="<?php if($currentPage == 'cardDetails'){echo 'active';}?>card_details_view2" >CARD DETAILS</a></li><br>
                <li><a class="<?php if($currentPage =='tools'){echo 'active';}?>" href="tools">TOOLS</a></li><br>
                
                <li><a class="<?php if($currentPage =='support'){echo 'active';}?>" href="support">SUPPORT</a></li><br>
                <li><a class="<?php if($currentPage =='support'){echo 'active';}?>" href="profileSettings">PROFILE</a></li>
            </ul>
        </div>
