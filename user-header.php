    ...
    <div class="navbar" style="z-index: 999; display: flex; justify-content: space-evenly;">
        ...
        <div class="nav" id="myHeader">
            ...
            <div style="text-align: center; margin-left: 100px; justify-content: center; display: flex;"
                ...
                <a class="<?php if($currentPage =='cardDetails'){echo 'active';}?>" href="card_details_view2">CARD
                    DETAILS</a>
        ...
        <div class="mobile-menu-list" style="display: none;">
            ...
            <ul class="">
                ...
                <li><a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details">CREATE
                        CARD</a></li><br>

                <li><a href="<?php if($currentPage == 'cardDetails'){echo 'active';}?>card_details_view2">CARD
                        DETAILS</a></li><br>
