...
<body>
    ...
    <div style="padding: 0;" class="container">
        ...
        <div class="profile-img profile3-img">
            ...
            <svg version="1.1" class="qrc_profile_5_svg" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                style="enable-background:new 0 0 375 171;     margin-top: -176px;" xml:space="preserve">
            ...
            <div style="margin-top: -41px;">
                ...
                <h2 style="text-align: left; margin-left: 20px;"><?php echo $fname, ' ', $lname?></h2>

                <p style="text-align: left; margin-left: 20px;"><?php echo $jobtitle; ?></p>

                <p style="text-align: left; margin-left: 20px;"><b><?php echo  $company;?></b></p>
        ...
        <div style="padding: 20px;">
            ...
            <div class="contact profile3-contact">
        ...
        echo "<script>const sec_color = '$sec_color';</script>";

        echo "<script>const text_color = '$text_color';</script>";
        ...
        ?>
            ...
            <?php
                ...
                $slide = mysqli_query($db, "SELECT * FROM images WHERE card_id = $id");

                if(mysqli_num_rows($slide)>0){

                    while($sliderow = mysqli_fetch_assoc($slide)){

                        $imagepath = $sliderow['file_name'];
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide profile-slide" data-bs-ride="carousel">
    ...
    ?>
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                <a href="tel:<?php echo $phone; ?>">
                    <button class="btn btn-primary"><i class="bi bi-telephone-fill"></i> Dial Me</button>
                </a>
            </div>
        </div>
    ...
    root.style.setProperty('--secondary', sec_color);

    root.style.setProperty('--secondarytext', text_color);
