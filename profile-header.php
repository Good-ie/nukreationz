...
<head>
    ...
    <meta name="keywords"
        content="QR Code Generator, QR Code Generator, Free QR Code Generator, Free QR Code Generator Online, QR Code Management Platform, Professional QR Code Generato, Business QR Code Generator, custom QR Codes" />
    ...
    <meta property="og:description"
        content="Experience the power of our top-rated QR Code generator and management platform designed for businesses and marketing purposes. Generate custom QR Codes with ease, incorporating logos, advanced analytics, bulk upload capabilities, APIs, and various shapes. Our platform supports a wide range of applications, including links, social media, apps, forms, URLs, vCards, Facebook, Instagram, websites, YouTube, and much more. Get started today and elevate your QR Code strategy to new heights.">
    ...
    <div class="navbar" style="display: flex; justify-content: space-evenly;">
        <div class="nav" id="myHeader">
            ...
            <div style="display: flex; margin-left: 100px;" id="login-user-button" class="">
                ...
                <img class="img" style=" object-fit: cover; width: 50px; cursor: pointer; height: 50px; margin-top: px; border-radius: 50%; background: #D9D9D9;
                        box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.12); padding: 2px;" src="<?php if(!empty($profileimage)){echo'uploads/',$profileimage;}else{echo'img/user-img.png';} ?>"
                    alt="nukreationz" ">
        ...
        <div class=" top-profile-card " style=" display: none;">
                ...
                <ul>
                    <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>"
                            href="profileSettings.php">Profile</a></li>
                    <li><a class="<?php if($currentPage =='userProfile'){echo 'active';}?>"
                            href="profileSettings.php">Settings</a></li>
        ...
        <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                ...
                <!-- <a href="">ABOUT US</a> -->
                <li><a class="<?php if($currentPage =='profile'){echo 'active-set';}?>"
                        href="profileSettings.php">PROFILE</a>
                </li><br>

                <li><a class="<?php if($currentPage =='password'){echo 'active-set';}?>"
                        href="passwordSettings.php">PASSWORD</a>
                </li>
                <br>

                <li><a class="<?php if($currentPage =='billing'){echo 'active-set';}?>" href="billing.php">BILLING</a>
                </li>
                <br>
                <li><a class="<?php if($currentPage =='notification'){echo 'active-set';}?>"
                        href="notification.php">NOTIFICATION</a></li><br>
            </ul>
        </div>
