                ...
                <form action="card_details.php" method="POST" enctype="multipart/form-data" class="info">
                        ...
                        <div style="display: block;" class="color-custom first-close">
                            ...
                            <div style="display: flex; margin-top: 21px;">
                                ...
                                <div>
                                    ...
                                    <div class="color-picker-icon"><i class="bi bi-eyedropper"></i></div>
                                    <input class="color-input-sec" value="" type="text" name="color-input-sec" placeholder="">
                    ...
                    <div class="basic-info">
                        ...
                        <div style="display: block;" class="first-close">
                            ...
                            <textarea class="u-psmmary" style="margin-bottom: 30px;" name="psummary" id="" cols="30" rows="10" placeholder="Professional Summary"></textarea><br>
                    ...
                    <div class="form-content">
                            ...
                            <div class="social-buttons">
                                <div style="margin-left: 0; display: none;" class="facebook-input social-button">
                                    ...
                                    <input  id="social-check" type="text"  name="facebook-link" placeholder="https://facebook.com/profilename" value="">
                                    
                                </div>
                                <div class="instagram-input social-button" style="display: none;">
                                    <label  for="vehicle2"> <img src="img/instagram.png"> </label>
                                    <input class="social-check" type="text" id="vehicle2" name="instagram-link" placeholder="https://instagram.com/profilename" value="">
                                    
                                </div>
                                <div class="twitter-input social-button" style="display: none;">
                                    <label  for="vehicle2"> <img src="img/twitter.png"> </label>
                                    <input class="social-check" type="text" id="vehicle2" name="twitter-link" placeholder="https://twitter.com/username" value="">
                            ...
                            <div class="social-buttons">
                                <div style="margin-left: 0; display: none;" class="whatsapp-input social-button">
                                    ...
                                    <input class="social-check" type="text" id="vehicle1" name="whatsapp-link" placeholder="whatsapp chat link" value="">
                                    
                                </div>
                                <div class="linkedin-input social-button" style="display: none;">
                                    <label  for="vehicle2"> <img src="img/link.png" alt=""> </label>
                                    <input class="social-check" type="text" id="vehicle2" name="linkedin-link" value="" placeholder="https://instagram.com/username">
                                    
                                </div>
                                <div class="pintrest-input social-button" style="display: none;">
                                    <label  for="vehicle2"> <img src="img/pin.png" alt=""> </label>
                                    <input class="social-check" type="text" id="vehicle2" name="pin-link" value="" placeholder="https://pintrest.com/username">
                            ...
                            <div style="margin-left: 0px; display: none;" class="socila-button">
                                <div style="margin-left: 0px;" class="youtube-input social-button" style="display: none;">
                                    ...
                                    <input class="social-check" type="text" id="vehicle2" name="youtube-link" value="" placeholder="https://youtube.com/username">
                    ...
                    <div class="image-slider">
                        ...
                        <div style="margin-top: 55px; display: block" class="images image third-close">
                            ...
                            <img src="./img/user-img.png" id="pimage2" class= "profile-image" style="width: 180px; height: 180px; object-fit: cover; border-radius: 50%; border: 5px solid #686868;">
