...
<head>
    ...
    <link rel="stylesheet" href="css/prototype3.css">
    <title></title>
</head>
...
<body>
    ...
    <div class="pro3container">
        <div class="Pro-profile-img">
            ...
            <div style="text-align: left;  display: flex; margin-top: 30px; " class="prototype-profile-name">
                <div>
                    <h2 style="font-size: 25px; font-weight: 700;" class="pro-name">Firstname</h2>
                </div>
                <div style="margin-left: 10px;" id="pro-lname">
                    <h2 style="font-size: 25px; font-weight: 700;" class="pro-lname">Lastname</h2>
                </div>
            </div>
        ...
        <div class="about">
            <h2>About</h2>
            <textarea
                style="overflow: auto; text-align: center; display: flex; justify-content: center; align-items: center; border: none;"
