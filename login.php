...
?>
    ...
    <div class="container1">
        <div class="login">
            <h2>Login &nbsp;| </h2>&nbsp;<a style="text-decoration: none;" href="register"><h3>Signup</h3></a>
        </div>
        ...
        <div class="login-footer">
            <div style="display: flex;">
                 <p class="checkbox" style="font-size: 13px;"> Remember Me </p><input style="margin-left: 12px; margin-top: -14px;" type="checkbox">
            </div>
            <div>
