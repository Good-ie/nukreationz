...
<?php
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" id="edited-img" style="height: 170px; width: 170px; object-fit: cover;" src="uploads/<?=$row['images'] ?>" alt="gyhfast">
            <button id="edit-image-button"
                        style="top: 226px;" class="position-absolute top-0 end-0 btn btn-sm btn-primary" type="button">
            ...
            <form action="<?php echo "social_edit?id=$id"?>" method="POST">
                        ...
                        <div class="col-md-12"><label class="labels"><i style="color: blue;" class="bi bi-twitter"></i>
                                &nbsp; Twitter </label><input type="text" class="form-control" placeholder=""
                        ...
                        <div class="col-md-12"><label class="labels"><i style="color: #FF0000;"
                                ...
                                &nbsp; Youtube</label><input type="text" class="form-control" placeholder=""
                                name="youtube" value="<?php echo $youtube; ?>">
                        </div>
                        <input style="padding: 8px 15px; border: none; cursor: pointer; background: #ff8f03; color: #fff; margin-top: 20px; border-radius: 6px; margin-bottom: 20px;" type="submit" name="reg_user" value="Save">
                        <?php
                }
            }
            ?>
