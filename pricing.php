    ...
    <div class="normal-monthly-plan " style="display: flex; justify-content: space-around;     padding: 0 100px;">
        ...
        <div class="monthly-plans">
            <div class="plan">
                ...
                <div>
                    ...
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Scans per month <b>50</b></li>
        ...
        <div class=" monthly-plans">
            <div class="plan">
                ...
                $plan = "starter";
                $period = "monthly";
                $url = "subscribe?plan=$plan&period=$period";
                ?>
                <div style="display: flex; justify-content: space-between; width: 260px;">
                    <div>
                        <p>Starter plan</p>
                ...
                <div>
                    ...
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Scans per month <b>500</b></li>
        ...
        <div class="monthly-plans">
            <div class="plan">
                ...
                <div>
                    ...
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Scans per month <b>1000</b></li>
                        ...
                        <li style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Analytics <b>Advance</b></li>
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Daily analytics in email <b>Yes</b></li>
        ...
        <div class="monthly-plans ">
            <div class="plan">
                ...
                <div>
                    ...
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Scans per month <b>5000</b></li>
                        <li><i class="bi bi-check-circle"></i> Total tools accessible <b>All</b></li>
                        ...
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Analytics <b>Advance</b></li>
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Daily analytics in email <b>Yes</b></li>
                        <li  style="text-decoration: line-through;"i><i class="bi bi-check-circle"></i> Analytics excel download <b>Yes</b></li>
                    </ul>
                </div>
            ...
            <div class="plan">
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Analytics <b>Advance</b></li>
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Daily analytics in email <b>Yes</b></li>
                        <li  style="text-decoration: line-through;"><i class="bi bi-check-circle"></i> Analytics excel download <b>Yes</b></li>
                    </ul>
                </div>
...
<script>
    ...
    year_button.addEventListener("click", function () {
      ...
      month_plan.classList.remove("normal-monthly-plan");
