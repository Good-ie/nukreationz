...
$original_url = "https://nukreationzdigital.com/qr/profile2?id=$id";
...
<?php
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" style="height: 170px; width: 170px; object-fit: cover;" src="uploads/<?=$row['images'] ?>" alt="gyhfast"><span class="font-weight-bold"><?php echo $fname; ?></span><span class="text-black-50"><?php echo $email; ?></span><span> </span>
        ...
        <div class="col-md-5 border-right">
            ...
            <div class="p-3 py-5">
                ...
                <div class="mt-5 text-center"><a href="card_details_view2"><button class="btn btn-primary profile-button" type="button">Save Profile</button></a></div>
                <div class="mt-5 text-center"><a href="<?php echo "https://nukreationzdigital.com/qr/edit?id=$id" ?>"><button style="background: #000 !important;" class="btn btn-primary profile-button" type="button">Edit Profile</button></a></div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">User Profile Link</label><input type="text"  id="custom-link" readonly class="form-control"  value="<?php echo "https://nukreationzdigital.com/qr/$profilepage?id=$id" ?>"></div>
            ...
            <?php
                ...
                $link = "https://nukreationzdigital.com/qr/profile2?id=$id";
...
<div class="container rounded bg-white mt-5 mb-5">
        ...
        if(mysqli_num_rows($imglist)>0){
            ...
            ?>
                <div class="single-img">
                    ...
                    <img style="width: 200px; height: 200px display: inline-block;" src="<?php echo $img ?>"
                        alt="">
                    <!-- <a style="justify-self: end;" href="">
        ...
        ?>
                <!-- <div class="add-more-img">
                    <label style="position: relative;">
                        ...
                        <input type="file" style="position: absolute; top: 0; left: 0; opacity: 0;" />
                    </label>
                </div> -->
    ...
    custom_btn.addEventListener('click', function() {
        console.log('custom link btn');
        link_input.removeAttribute('readonly');
