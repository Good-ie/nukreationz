...
$sql2 = mysqli_query($db, "SELECT * from card_details WHERE id = $id ");
    ...
    if(mysqli_num_rows($sql2)>0){
        ...
        $original_url = "https://nukreationzdigital.com/qr/$profilepage?id=$id";
        ...
        $sql33 = mysqli_query($db, "SELECT * from user_social_link WHERE card_id = $id ");
            ...
            <div class="col-md-5 border-right">
                ...
                <div class="p-3 py-5">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <div class="mt-5 text-center"><a href="card_details_view2"><button
                                    class="btn btn-primary profile-button" type="button">Save Profile</button></a></div>

                        <div class="mt-5 text-center"><a
                                href="<?php echo "https://nukreationzdigital.com/qr/edit-pro?id=$id&pgd=$user_id"; ?>"><button
            ...
            <div class="col-md-4">
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="col-md-12"><label class="labels">User Profile Link</label><input type="text"
                            id="custom-link" readonly class="form-control"
                            value="<?php echo "https://nukreationzdigital.com/qr/$profilepage?id=$id" ?>"></div>
        ...
        if(mysqli_num_rows($imglist)>0){
            ...
            ?>
                ...
                <div class="single-img">
                    ...
                    <img style="width: 200px; height: 200px display: inline-block;" src="<?php echo $img ?>" alt="">
