        ...
        <form action="" method="POST">
            ...
            <div class="qrcode-basic-info">
                ...
                <div style="margin-bottom: 40px;" class="qrcode-form">
                    ...
                    <input style="width: 120px;" type="number" name="country-code" placeholder="Country code" autofocus
                        required>

                    <input style="width: 280px;" type="text" name="number" placeholder="Your whatsapp number" autofocus
                        required>
